...
&nbsp;
const Avatar = <span class="fstat-no" title="function not covered" >({</span>
  onPress,
  onLongPress,
  component: Component = <span class="branch-0 cbranch-no" title="branch not covered" >onPress || onLongPress ? TouchableOpacity : View,</span>
  containerStyle,
  icon,
  iconStyle,
  source,
  ...
  const width =
<span class="cstat-no" title="statement not covered" >    typeof size === 'number'</span>
      ? size
      : DEFAULT_SIZES[size] || DEFAULT_SIZES.small;
  const height = <span class="cstat-no" title="statement not covered" >width;</span>
  const titleSize = <span class="cstat-no" title="statement not covered" >width / 2;</span>
  const iconSize = <span class="cstat-no" title="statement not covered" >width / 2;</span>
  const editButtonSize = <span class="cstat-no" title="statement not covered" >editButton.size || (width + height) / 2 / 3;</span>
&nbsp;
  const Utils = <span class="cstat-no" title="statement not covered" >showEditButton &amp;&amp; (</span>
    &lt;TouchableHighlight
      style={[
        styles.editButton,
        {
...
<span class="cstat-no" title="statement not covered" >    (renderPlaceholderContent &amp;&amp;</span>
...
&nbsp;
  onLoadEnd = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
    /* Images finish loading in the same frame for some reason,
      the images will fade in separately with staggerNonce */
    const minimumWait = <span class="cstat-no" title="statement not covered" >100;</span>
    const staggerNonce = <span class="cstat-no" title="statement not covered" >200 * Math.random();</span>
<span class="cstat-no" title="statement not covered" >    setTimeout(</span>
<span class="fstat-no" title="function not covered" >      ()</span> =&gt;
<span class="cstat-no" title="statement not covered" >        Animated.timing(this.placeholderContainerOpacity, {</span>
          toValue: 0,
          duration: 350,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return Platform.OS === 'ios' ? (</span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Oct 10 2018 16:44:32 GMT-0400 (AST)
</div>
</div>
